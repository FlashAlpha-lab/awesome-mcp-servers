...
- <img src="https://flashalpha.io/favicon.ico" height="14"/> [FlashAlpha](https://github.com/FlashAlpha-lab/flashalpha-mcp) - Real-time options analytics — gamma/delta/vanna/charm exposure, dealer positioning, 0DTE analytics, SVI volatility surfaces, VRP, Black-Scholes greeks, Kelly sizing, and historical tick data for US equities.
